-- ----------------------------
--  Table structure for `redstore_category`
-- ----------------------------
DROP TABLE IF EXISTS `redstore_category`;
CREATE TABLE `redstore_category` (
